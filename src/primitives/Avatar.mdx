...
The Avatar component displays a rounded image representing an avatar. The component supports multiple sources, with fallbacks in place if a source fails during runtime.
