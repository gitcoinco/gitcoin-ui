...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "ui-rounded-lg ui-border ui-border-neutral-200 ui-bg-white ui-text-neutral-950 ui-shadow-sm dark:ui-border-neutral-800 dark:ui-bg-neutral-950 dark:ui-text-neutral-50",
      className
    )}
    {...props}
  />
