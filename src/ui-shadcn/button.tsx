...
const buttonVariants = cva(
  "ui-inline-flex ui-items-center ui-justify-center ui-gap-2 ui-whitespace-nowrap ui-rounded-md ui-text-sm ui-font-medium ui-ring-offset-white ui-transition-colors focus-visible:ui-outline-none focus-visible:ui-ring-2 focus-visible:ui-ring-neutral-950 focus-visible:ui-ring-offset-2 disabled:ui-pointer-events-none disabled:ui-opacity-50 [&_svg]:ui-pointer-events-none [&_svg]:ui-size-4 [&_svg]:ui-shrink-0 dark:ui-ring-offset-neutral-950 dark:focus-visible:ui-ring-neutral-300",
  {
    variants: {
      variant: {
        default: "ui-bg-neutral-900 ui-text-neutral-50 hover:ui-bg-neutral-900/90 dark:ui-bg-neutral-50 dark:ui-text-neutral-900 dark:hover:ui-bg-neutral-50/90",
        destructive:
        ...
        ghost: "hover:ui-bg-neutral-100 hover:ui-text-neutral-900 dark:hover:ui-bg-neutral-800 dark:hover:ui-text-neutral-50",
