...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "ui-flex ui-h-10 ui-items-center ui-space-x-1 ui-rounded-md ui-border ui-border-neutral-200 ui-bg-white ui-p-1 dark:ui-border-neutral-800 dark:ui-bg-neutral-950",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "ui-flex ui-cursor-default ui-select-none ui-items-center ui-rounded-sm ui-px-3 ui-py-1.5 ui-text-sm ui-font-medium ui-outline-none focus:ui-bg-neutral-100 focus:ui-text-neutral-900 data-[state=open]:ui-bg-neutral-100 data-[state=open]:ui-text-neutral-900 dark:focus:ui-bg-neutral-800 dark:focus:ui-text-neutral-50 dark:data-[state=open]:ui-bg-neutral-800 dark:data-[state=open]:ui-text-neutral-50",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.SubContent
    ref={ref}
    className={cn(
      "ui-z-50 ui-min-w-[8rem] ui-overflow-hidden ui-rounded-md ui-border ui-border-neutral-200 ui-bg-white ui-p-1 ui-text-neutral-950 data-[state=open]:ui-animate-in data-[state=closed]:ui-animate-out data-[state=closed]:ui-fade-out-0 data-[state=open]:ui-fade-in-0 data-[state=closed]:ui-zoom-out-95 data-[state=open]:ui-zoom-in-95 data-[side=bottom]:ui-slide-in-from-top-2 data-[side=left]:ui-slide-in-from-right-2 data-[side=right]:ui-slide-in-from-left-2 data-[side=top]:ui-slide-in-from-bottom-2 dark:ui-border-neutral-800 dark:ui-bg-neutral-950 dark:ui-text-neutral-50",
      className
    )}
    {...props}
  />
  ...
  (
    ...
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.Content
        ...
        className={cn(
          "ui-z-50 ui-min-w-[12rem] ui-overflow-hidden ui-rounded-md ui-border ui-border-neutral-200 ui-bg-white ui-p-1 ui-text-neutral-950 ui-shadow-md data-[state=open]:ui-animate-in data-[state=closed]:ui-fade-out-0 data-[state=open]:ui-fade-in-0 data-[state=closed]:ui-zoom-out-95 data-[state=open]:ui-zoom-in-95 data-[side=bottom]:ui-slide-in-from-top-2 data-[side=left]:ui-slide-in-from-right-2 data-[side=right]:ui-slide-in-from-left-2 data-[side=top]:ui-slide-in-from-bottom-2 dark:ui-border-neutral-800 dark:ui-bg-neutral-950 dark:ui-text-neutral-50",
          className
        )}
        {...props}
      />
